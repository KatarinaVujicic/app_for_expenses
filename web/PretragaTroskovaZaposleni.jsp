...
<html>
    ...
    >
            <form action="./PretragaTroskovaServletZaposleni" method="post">
                    ...
                    <tbody >
                        <c:forEach items="${lista1}" var="t">    
                            <tr>
                                ...
                                <td><a class="btn btn-primary btn-sm" href="./VracanjeZaTrosakServlet?trID=${t.trosakID}">Unesite racun za trošak</a>
                                </td>
                                <td><a class="btn btn-primary btn-sm" href="./VracanjeTroskaZaRacuneServlet?trID=${t.trosakID}">Prikaz svih račune za trošak</a>
                                </td>
