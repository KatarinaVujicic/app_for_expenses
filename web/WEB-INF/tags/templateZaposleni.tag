<%-- 
    Document   : templateZaposleni
    Created on : May 14, 2021, 12:36:55 PM
    Author     : Katarina
--%>
                    ...
                    <li class="nav-item dropdown dmenu">
                        ...
                        <div class="dropdown-menu sm-menu">
                             <c:forEach var="zap" items="${listaZaVracanje}">
                                 <a class="dropdown-item" href="./PretragaTroskovaServletZaposleni?zaposleniId=${zap.zaposleniId}">Pretraga troškova</a></c:forEach>
                              <c:forEach var="zap" items="${listaZaVracanje}">
                            <a class="dropdown-item" href="./UnosTroskaZaposleniServlet?zaposleniId=${zap.zaposleniId}">Unos novog troška</a>
                        </c:forEach>
