<%-- 
    Document   : nesto
    Created on : May 14, 2021, 12:28:30 PM
    Author     : Katarina
--%>
                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        ...
                        <div class="dropdown-menu sm-menu">
                            <a class="dropdown-item" href="./UnosZaposlenogSupervizor">Unos novog zaposlenog</a>
                    ...
                    <li class="nav-item dropdown dmenu">
                        ...
                        <div class="dropdown-menu sm-menu">
                            ...
                            <a class="dropdown-item" href="./UnosNovogTroska?zaposleniId=${zap.zaposleniId}">Unos novog troška</a>
                           <a  class="dropdown-item" href="./PretragaTroskovaSupervizorServlet?zaposleniId=${zap.zaposleniId}">Pretraga troškova</a>
                        </c:forEach>
