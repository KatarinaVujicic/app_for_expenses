...
<legend><center><h2><b>Unos novog računa</b></h2></center></legend><br>
<form action="./UnosRacuna" method="post" name="f" onsubmit="return validLogin();">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="br"  name="brojRacuna" placeholder="Broj racuna" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="ui" placeholder="Ukupan iznos računa" name="ui" required="">
                        ...
                        <input type="submit" class="btn btn-primary btn-md"  value="Zapamti"/>
