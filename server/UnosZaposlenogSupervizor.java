 ...
 * @author Katarina
 */
@WebServlet(name = "UnosZaposlenogSupervizor", urlPatterns = {"/UnosZaposlenogSupervizor"})
public class UnosZaposlenogSupervizor extends HttpServlet {
   ...
   @EJB
          ...
          //  out.println(tip1);
            ...
            lista = sbZaposleni.vratiListuZaposlenih();
             ...
             for (Zaposleni z : lista) {
                if (z.getJmbg().equals(JMBG) && !z.equals(zap)) {
                    ...
                    request.getRequestDispatcher("UnosZaposlenogSupervizor.jsp").include(request, response);
                    return;
                }
            }
            if (JMBG.length() != 13) {
            ...
            for (Zaposleni z : lista) {
               ...
               out.println("<script type=\"text/javascript\">"
                    ...
                    out.println("</script>");
                    request.getRequestDispatcher("templateSupervizor.jsp").include(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/UnosZaposlenogSupervizor.jsp").forward(request, response);
    }
