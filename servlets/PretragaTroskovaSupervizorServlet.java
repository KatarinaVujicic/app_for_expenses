 ...
 * @author Katarina
 */
@WebServlet(name = "PretragaTroskovaSupervizorServlet", urlPatterns = {"/PretragaTroskovaSupervizorServlet"})
public class PretragaTroskovaSupervizorServlet extends HttpServlet {
