 ...
 * @author Katarina
 */
@WebServlet(name = "PretragaRacunaSupervizor", urlPatterns = {"/PretragaRacunaSupervizor"})
public class PretragaRacunaSupervizor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("./PretragaRacunaSupervizor.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        }}
