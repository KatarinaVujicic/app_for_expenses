 ...
 * @author Katarina
 */
@WebServlet(name = "UnosTroskaZaposleniServlet", urlPatterns = {"/UnosTroskaZaposleniServlet"})
@ManagedBean
public class UnosTroskaZaposleniServlet extends HttpServlet {
  @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     try{
      ...
      Zaposleni zap = sbZap.vratiZaposlenog(id);
           ...
           response.sendRedirect("./PretragaTroskovaServletZaposleni");
//                    out.println("<script type=\"text/javascript\">"
//                    );
//                    out.println("alert('Uspešno ste kreirali novi trošak');");
//                    out.println("</script>");
//            request.getRequestDispatcher("./templateZaposleni.jsp").include(request, response);
//       request.getRequestDispatcher("./templateSupervizor.jsp").forward(request, response);
       ...
       e.printStackTrace();
         response.setContentType("text/html");
                    ...
                    out.println("</script>");
                    request.getRequestDispatcher("./templateZaposleni.jsp").forward(request, response);
       }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/UnosTroskaZaposleni.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      Zaposleni zap = sbZap.vratiZaposlenog(id);
            ...
            tr.setZaposleni(zap);
            sbTrosak.sacuvajTrosak(tr);
             response.sendRedirect("./PretragaTroskovaServletZaposleni?zaposleniId=" + tr.getZaposleni().getZaposleniId());
        out.println("<script type=\"text/javascript\">"
                    );
                    out.println("alert('Uspešno ste kreirali novi trošak');");
                    out.println("</script>");
